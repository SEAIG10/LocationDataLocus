...
export type MessageType = 'location' | 'arkit_location' | 'identify' | 'ping' | 'pong' | 'welcome' | 'location_update' | 'server_shutdown';
...
export type WebSocketMessage = LocationData | ARKitLocationData | IdentifyMessage | PingMessage | PongMessage | WelcomeMessage | LocationUpdateMessage | ServerShutdownMessage;
