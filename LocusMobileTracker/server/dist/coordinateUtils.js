 ...
 * @returns 필터링된 3D 좌표
 */
export function gpsTo3DSmooth(gps, accuracy) {
 ...
 * @returns 평균화된 3D 좌표
 */
export function gpsTo3DAverage(gps) {
    const latDiff = gps.latitude - REFERENCE_POINT.latitude;
    const lonDiff = gps.longitude - REFERENCE_POINT.longitude;
    const rawPosition = {
 ...
 */
export function gpsTo3DHybrid(gps, accuracy) {
    // 1단계: 칼만 필터
 ...
 */
export function position3DToGPS(position) {
 ...
 */
export function updateReferencePoint(newReference) {
