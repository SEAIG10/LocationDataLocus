 ...
 */
import { gpsTo3DSmooth, evaluateAccuracy } from './coordinateUtils';
// 위치 업데이트 처리 함수
function handleLocationUpdate(data, ws) {
    const { latitude, longitude, accuracy } = data;
    // 🎯 방법 1: 칼만 필터만 (빠르고 반응성 좋음)
    const position3D = gpsTo3DSmooth({ latitude, longitude }, accuracy);
